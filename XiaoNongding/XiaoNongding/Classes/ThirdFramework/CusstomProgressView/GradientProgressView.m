...
- (id)initWithFrame:(CGRect)frame {
    ...
    if ((self = [super initWithFrame:frame])) {
        ...
        for (NSInteger deg = 0; deg <= 160; deg += 5) {
...
- (void)performAnimation {
    ...
    //1  Update the colors on the model layer
    ...
    //2  Create an animation to slowly move the hue gradient left to right.
    ...
    //3  Add the animation to our layer
