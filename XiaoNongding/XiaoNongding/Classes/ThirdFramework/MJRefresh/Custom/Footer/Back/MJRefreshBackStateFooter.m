...
-(UIImageView *)bgView{
    if (!_bgView) {
        UIImageView* bg_View = [[UIImageView alloc] initWithFrame:CGRectMake(kDeviceWidth/2.0-125.0, 10.0, 250.0, 50.0)];
        bg_View.image=[UIImage imageNamed:@"bgDefault.png"];
        [self addSubview:_bgView = bg_View];
    }
    return _bgView;
}
#pragma mark - 公共方法
