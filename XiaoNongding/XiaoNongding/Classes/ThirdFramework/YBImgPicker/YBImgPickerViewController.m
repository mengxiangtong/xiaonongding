...
#define rightItemTitle [NSString stringWithFormat:@"完成 %ld/%ld",(long)choosenCount,(long)_photoCount]
...
@property (nonatomic , retain) id <YBImgPickerViewControllerDelegate> delegate;
