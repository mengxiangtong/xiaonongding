...
@property (nonatomic, retain) UILabel *lb_couponFlgtext;
@property (nonatomic, retain) UIImageView *img_couponFlg;
@property (nonatomic, retain) UIImageView *img_couponBg;
