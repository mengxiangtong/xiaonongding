...
@interface NoPayViewController ()<UITableViewDataSource, UITableViewDelegate,OrderTableViewCellDelegate>
...
-(void)loadOrderData{
    ...
    NSURL *url = [NSURL URLWithString: [NSString stringWithFormat: KOrder_List_URL,@"1",pageIndex,uid,token ] ];
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url ];
    request.timeoutInterval=KHTTPTimeoutInterval;
    [request setHTTPMethod:@"GET"];
    
    __block NoPayViewController *weakSelf = self;
