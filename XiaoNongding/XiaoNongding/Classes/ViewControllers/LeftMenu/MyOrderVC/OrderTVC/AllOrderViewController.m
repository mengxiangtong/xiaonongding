...
@interface AllOrderViewController ()<UITableViewDataSource, UITableViewDelegate,OrderTableViewCellDelegate>
...
-(void)loadOrderData{
    ...
    NSURL *url = [NSURL URLWithString: [NSString stringWithFormat: KOrder_List_URL,@"",pageIndex,uid,token ] ];
    NSMutableURLRequest *request = [NSMutableURLRequest requestWithURL:url ];
    request.timeoutInterval=KHTTPTimeoutInterval;
    [request setHTTPMethod:@"GET"];

    
    __block AllOrderViewController *weakSelf = self;
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.superVC=self;
    cell.delegate=self;
    if(self.arry_AllOrder.count>indexPath.row){
